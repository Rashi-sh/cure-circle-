...
const footerLinks = {
  platform: [
    ...
    { href: "/consult", label: "Find Doctors" },
    { href: "/family", label: "Family Care" },
  ],
  support: [
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Care that connects, healing that lasts. Bridging traditional wisdom with modern medicine for holistic healthcare.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-2 text-sm text-muted-foreground">
                ...
                <span>support@curecircle.in</span>
              </li>
              <li className="flex items-center gap-2 text-sm text-muted-foreground">
        ...
        <div className="mt-12 border-t border-border pt-8">
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            <p className="text-sm text-muted-foreground">
              &copy; {new Date().getFullYear()} CureCircle. All rights reserved.
            </p>
